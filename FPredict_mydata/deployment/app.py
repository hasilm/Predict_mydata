...
skin = st.number_input("Triceps Skinfold Thickness (mm)", min_value=0, max_value=110, value=20)
test = st.number_input("2-Hour Serum Insulin (mu U/ml)", min_value=0, max_value=930, value=80)
